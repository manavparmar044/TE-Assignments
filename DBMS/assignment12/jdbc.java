...
public class Connect {
    ...
    private static void deleteDocument() {
        ...
        Document result = collection.findOneAndDelete(new Document("name", scanner.nextLine()));
        System.out.println(result != null ? "Document deleted: " + result.toJson() : "Document not found.");
    }

    private static void findDocument() {
        System.out.print("Enter the name of the document to find: ");
        Document doc = collection.find(new Document("name", scanner.nextLine())).first();
